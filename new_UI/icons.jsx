// Icon set — minimal monoline. Expose globally for all babel scripts.
const Icon = ({ name, size = 16, stroke = 1.6, className = "", style = {} }) => {
  ...
  switch (name) {
    ...
    case "swap": return (<svg {...props}><path d="M7 4 3 8l4 4M3 8h14M17 20l4-4-4-4M21 16H7"/></svg>);
    case "tag": return (<svg {...props}><path d="M20.59 13.41 13.42 20.58a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><circle cx="7" cy="7" r="1.5"/></svg>);
    ...
    case "wallet": return (<svg {...props}><path d="M3 7a2 2 0 0 1 2-2h13a1 1 0 0 1 1 1v3"/><rect x="3" y="7" width="18" height="13" rx="2"/><circle cx="16" cy="13.5" r="1.2"/></svg>);
    case "piggy": return (<svg {...props}><path d="M19 9c1.5 0 2 1 2 2v3c0 1-1 2-2 2l-1 .5L17 18h-2l-.5-1.5h-5L9 18H7l-1-1.5C4 16 3 14 3 12s2-5 6-5h6c2 0 4 1 4 2zM7 10v.01"/></svg>);
    ...
    case "more": return (<svg {...props}><circle cx="12" cy="5" r="1.4"/><circle cx="12" cy="12" r="1.4"/><circle cx="12" cy="19" r="1.4"/></svg>);
    case "arrow-up-r": return (<svg {...props}><path d="M7 17 17 7M7 7h10v10"/></svg>);
    case "arrow-dn-r": return (<svg {...props}><path d="M7 7l10 10M17 7v10H7"/></svg>);
    case "camera": return (<svg {...props}><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3z"/><circle cx="12" cy="13" r="3.5"/></svg>);
    case "mic": return (<svg {...props}><rect x="9" y="2" width="6" height="12" rx="3"/><path d="M5 11a7 7 0 0 0 14 0M12 18v4"/></svg>);
    case "yen": return (<svg {...props}><path d="M5 4l7 9 7-9M7 13h10M7 17h10M12 13v8"/></svg>);
    ...
    case "receipt": return (<svg {...props}><path d="M4 2h16v20l-3-2-3 2-2-2-2 2-3-2-3 2z"/><path d="M8 7h8M8 11h8M8 15h5"/></svg>);
    case "clock": return (<svg {...props}><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>);
    case "coffee": return (<svg {...props}><path d="M3 8h14v6a4 4 0 0 1-4 4H7a4 4 0 0 1-4-4z"/><path d="M17 10h2a2 2 0 0 1 0 4h-2"/><path d="M7 4v2M11 4v2M15 4v2"/></svg>);
    case "shopping": return (<svg {...props}><path d="M3 6h2l2.5 12a2 2 0 0 0 2 1.6h7a2 2 0 0 0 2-1.6L21 9H6"/><circle cx="9" cy="22" r="1"/><circle cx="18" cy="22" r="1"/></svg>);
    case "bus": return (<svg {...props}><rect x="4" y="4" width="16" height="13" rx="2"/><path d="M4 11h16M7 17v2M17 17v2"/><circle cx="8" cy="14.5" r="1"/><circle cx="16" cy="14.5" r="1"/></svg>);
    case "home": return (<svg {...props}><path d="M3 11l9-8 9 8v9a2 2 0 0 1-2 2h-4v-7h-6v7H5a2 2 0 0 1-2-2z"/></svg>);
    case "film": return (<svg {...props}><rect x="2" y="3" width="20" height="18" rx="2"/><path d="M2 7h4M18 7h4M2 12h20M2 17h4M18 17h4"/></svg>);
    case "bank": return (<svg {...props}><path d="M3 10 12 4l9 6"/><path d="M5 10v8M9 10v8M15 10v8M19 10v8M3 21h18"/></svg>);
    case "cash": return (<svg {...props}><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2.5"/><path d="M6 10v.01M18 14v.01"/></svg>);
    case "watch": return (<svg {...props}><circle cx="12" cy="12" r="6"/><path d="M9 6l1-3h4l1 3M9 18l1 3h4l1-3M12 9v3l2 1.5"/></svg>);
    case "plane": return (<svg {...props}><path d="m21 11-9 5L3 11l3-2 4 1 6-5 2 1-3 4 4 1z"/></svg>);
    case "command": return (<svg {...props}><path d="M9 9V6a3 3 0 1 0-3 3h12a3 3 0 1 0-3-3v3M9 15v3a3 3 0 1 1-3-3h12a3 3 0 1 1-3 3v-3M9 9h6v6H9z"/></svg>);
