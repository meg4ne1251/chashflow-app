...
class TransactionService(
    ...
    /** Batch-optimized response with pre-loaded tags (used by getAll) */
    private fun ResultRow.toResponseWithTags(tags: List<TagResponse>): TransactionResponse {
